...
public class IdentityClientV2 {
    ...
    public SchemaBuilder buildSchema(String displayName, String schemaType, String version, String description,
            String issuerDid) throws Exception {
        return new SchemaBuilder(displayName, schemaType, version, description, issuerDid, this.configData);
    }

    public CredentialBuilder buildCredential(String schemaId, String issuerDid, String holderDid, Long expiration,
            int version) throws Exception {
        return new CredentialBuilder(schemaId, issuerDid, holderDid, expiration, version, this.apiManagedHost,
                this.configData);
    }
