...
public class CredentialOffer {
    ...
    public static CredentialOffer fromJson(String json) throws Exception {
        ...
        Identity.CredentialOfferFromJsonRequest req = com.bloock.sdk.bridge.proto.Identity.CredentialOfferFromJsonRequest.newBuilder()
                .setConfigData(Config.newConfigDataDefault())
                .setJson(json)
                .build();

        Identity.CredentialOfferFromJsonResponse response = bridge.getIdentity().credentialOfferFromJson(req);
    ...
    public String toJson() throws Exception {
        ...
        Identity.CredentialOfferToJsonRequest req = com.bloock.sdk.bridge.proto.Identity.CredentialOfferToJsonRequest.newBuilder()
                .setConfigData(Config.newConfigDataDefault())
                .setCredentialOffer(this.toProto())
                .build();

        Identity.CredentialOfferToJsonResponse response = bridge.getIdentity().credentialOfferToJson(req);
