...
public class ManagedKeyParams {
    ...
    public ManagedKeyParams(KeyProtectionLevel protection, KeyType keyType, String name, long expiration) {
        this.name = name;
    ...
    public KeysEntities.ManagedKeyParams toProto() {
        KeysEntities.ManagedKeyParams.Builder params = KeysEntities.ManagedKeyParams.newBuilder()
