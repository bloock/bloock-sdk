...
public class BooleanAttributeDescriptor extends AttributeDescriptor {
  public BooleanAttributeDescriptor(String displayName, String technicalName, String description, Boolean required) {
    super(displayName, technicalName, description, required);
  }

  public static BooleanAttributeDescriptor fromProto(
      BooleanAttributeDefinitionV2 res) {
