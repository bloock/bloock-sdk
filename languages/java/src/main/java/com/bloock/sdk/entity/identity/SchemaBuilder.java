...
public class SchemaBuilder {
  ...
  public SchemaBuilder addBooleanAttribute(String name, String technicalName, String description) {
    this.booleanAttributes.add(
        new BooleanAttributeDescriptor(name, technicalName, description).toProto());
    return this;
  }

  public SchemaBuilder addDateAttribute(String name, String technicalName, String description) {
    this.dateAttributes.add(
        new DateAttributeDescriptor(name, technicalName, description).toProto());
    return this;
  }

  public SchemaBuilder addDatetimeAttribute(String name, String technicalName, String description) {
    this.datetimeAttributes.add(
        new DatetimeAttributeDescriptor(name, technicalName, description).toProto());
    return this;
  }

  public SchemaBuilder addStringAttribute(String name, String technicalName, String description) {
    this.stringAttributes.add(
        new StringAttributeDescriptor(name, technicalName, description).toProto());
    return this;
  }

  public SchemaBuilder addNumberAttribute(String name, String technicalName, String description) {
    this.numberAttributes.add(
        new NumberAttributeDescriptor(name, technicalName, description).toProto());
    return this;
  }
