...
public class DateAttributeDescriptor extends AttributeDescriptor {
  public DateAttributeDescriptor(String displayName, String technicalName, String description, Boolean required) {
    super(displayName, technicalName, description, required);
  }

  public static DateAttributeDescriptor fromProto(IdentityEntitiesV2.DateAttributeDefinitionV2 res) {
