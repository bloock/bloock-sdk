...
export const Configuration = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          break;
        case 11:
          message.identityApiHost = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): Configuration {
    return {
      ...
      identityApiHost: isSet(object.identityApiHost) ? String(object.identityApiHost) : undefined,
    };
  },
  ...
  toJSON(message: Configuration): unknown {
    ...
    message.identityApiHost !== undefined && (obj.identityApiHost = message.identityApiHost);
    return obj;
  },
