...
export class AccessControl {
   ...
   * @param accessControl
   */
  constructor(accessControl: AccessControlTotp | AccessControlSecret) {
  ...
  public toProto(): proto.AccessControl {
    ...
    if (this.accessControlTotp) {
      accessControlTotp =
        this.accessControlTotp && this.accessControlTotp.toProto();
    }

    let accessControlSecret: proto.AccessControlSecret | undefined;
    if (this.accessControlSecret) {
      accessControlSecret =
        this.accessControlSecret && this.accessControlSecret.toProto();
    }
