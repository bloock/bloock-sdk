...
export class CredentialCoreBuilder {
     ...
     * @returns 
     */
    public withStringAttribute(key: string, value: string): CredentialCoreBuilder {
     ...
     * @returns 
     */
    public withIntegerAttribute(key: string, value: number): CredentialCoreBuilder {
     ...
     * @returns 
     */
    public withDecimalAttribute(key: string, value: number): CredentialCoreBuilder {
     ...
     * @returns 
     */
    public withBoleanAttribute(key: string, value: boolean): CredentialCoreBuilder {
     ...
     * @returns 
     */
    public withDateTimeAttribute(key: string, value: Date): CredentialCoreBuilder {
