...
final class RecordTest extends TestCase
{
    ...
    public function testEciesEncryption()
    {
        $payload = "Hello world 2";
        $encryptionClient = new \Bloock\Client\EncryptionClient();
        $keyPair = $encryptionClient->generateEciesKeyPair();

        $recordClient = new \Bloock\Client\RecordClient();
        $encryptedRecord = $recordClient->fromString($payload)
            ->withEncrypter(new \Bloock\Entity\EciesEncrypter($keyPair->getPublicKey()))
            ->build();
    ...
    public function testEciesEncryptionHosted()
    {
        $payload = "Hello world 2";
        $encryptionClient = new \Bloock\Client\EncryptionClient();
        $keyPair = $encryptionClient->generateEciesKeyPair();
        ...
        $hash = $loadedRecord->getHash();
        $this->assertEquals("96d59e2ea7cec4915c415431e6adb115e3c0c728928773bcc8e7d143b88bfda6", $hash);
    }

    public function testEciesEncryptionIpfs()
    {
        $payload = "Hello world 2";
        $encryptionClient = new \Bloock\Client\EncryptionClient();
        $keyPair = $encryptionClient->generateEciesKeyPair();
