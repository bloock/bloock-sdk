...
/**
 * Generated from protobuf message <code>bloock.PublishRequest</code>
 */
class PublishRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.bloock.Publisher publisher = 3;</code>
     */
     ...
     *     @type \Bloock\Publisher $publisher
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.bloock.Publisher publisher = 3;</code>
     * @param \Bloock\Publisher $var
     * @return $this
     */
    public function setPublisher($var)
    {
        GPBUtil::checkMessage($var, \Bloock\Publisher::class);
        $this->publisher = $var;
