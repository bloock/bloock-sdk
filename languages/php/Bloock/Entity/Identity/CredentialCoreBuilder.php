...
use Bloock\CreateCoreCredentialRequest;
...
class CredentialCoreBuilder
{
     ...
     * @return $this
     */
    public function withStringAttribute(string $key, string $value): CredentialCoreBuilder
    {
     ...
     * @return $this
     */
    public function withIntegerAttribute(string $key, int $value): CredentialCoreBuilder
    {
     ...
     * @return $this
     */
    public function withDecimalAttribute(string $key, float $value): CredentialCoreBuilder
    {
     ...
     * @return $this
     */
    public function withBooleanAttribute(string $key, bool $value): CredentialCoreBuilder
    {
     ...
     * @return $this
     */
    public function withDateAttribute(string $key, DateTime $value): CredentialCoreBuilder
    {
     ...
     * @return $this
     */
    public function withDatetimeAttribute(string $key, DateTime $value): CredentialCoreBuilder
    {
    ...
    public function build(): CredentialReceipt
    {
        ...
        $req = new CreateCoreCredentialRequest();
        ...
        $res = $bridge->identityCore->CreateCoreCredential($req);
