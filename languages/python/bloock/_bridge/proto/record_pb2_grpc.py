...
class RecordService(object):
    ...
    def GetSignatureCommonName(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bloock.RecordService/GetSignatureCommonName',
    ...
    def GetSignatures(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bloock.RecordService/GetSignatures',
            record__pb2.Record.SerializeToString,
    ...
    def GetEncryptionAlg(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bloock.RecordService/GetEncryptionAlg',
            record__pb2.Record.SerializeToString,
    ...
    @staticmethod
    def GenerateRsaKeyPair(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bloock.RecordService/GenerateRsaKeyPair',
    ...
    @staticmethod
    def GenerateEciesKeyPair(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bloock.RecordService/GenerateEciesKeyPair',
    ...
    def Publish(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bloock.RecordService/Publish',
