...
class EncryptionService(object):
    ...
    def GenerateRsaKeyPair(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bloock.EncryptionService/GenerateRsaKeyPair',
    ...
    def GenerateEciesKeyPair(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bloock.EncryptionService/GenerateEciesKeyPair',
