...
_CONFIGDATA_NETWORKSCONFIGENTRY = _CONFIGDATA.nested_types_by_name[
    "NetworksConfigEntry"
]
...
ConfigData = _reflection.GeneratedProtocolMessageType(
    "ConfigData",
    (_message.Message,),
    {
        "NetworksConfigEntry": _reflection.GeneratedProtocolMessageType(
            "NetworksConfigEntry",
            (_message.Message,),
            {
