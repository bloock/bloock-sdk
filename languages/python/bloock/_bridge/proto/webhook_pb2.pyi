...
class VerifyWebhookSignatureRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "config_data", b"config_data", "enforceTolerance", b"enforceTolerance", "header", b"header", "payload", b"payload", "secretKey", b"secretKey"]) -> None: ...
...
class VerifyWebhookSignatureResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "_error", b"_error", "error", b"error", "is_valid", b"is_valid"]) -> None: ...
