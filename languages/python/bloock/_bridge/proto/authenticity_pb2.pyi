...
class SignRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "config_data", b"config_data", "record", b"record", "signer", b"signer"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class SignResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_error", b"_error", "error", b"error", "signature", b"signature"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class VerifyRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "config_data", b"config_data", "record", b"record"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class VerifyResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "_error", b"_error", "error", b"error", "valid", b"valid"
        ],
    ) -> None: ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_error", b"_error"]
...
class GetSignaturesResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        signatures: collections.abc.Iterable[authenticity_entities_pb2.Signature]
        | None = ...,
        error: shared_pb2.Error | None = ...,
    ) -> None: ...
    def HasField(
