...
class _NetworkEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Network.ValueType],
...
class ConfigData(google.protobuf.message.Message):
    ...
    @property
    def networks_config(self) -> google.protobuf.internal.containers.MessageMap[
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "config", b"config", "networks_config", b"networks_config"]) -> None: ...
...
class NetworkConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "ContractAbi", b"ContractAbi", "ContractAddress", b"ContractAddress", "HttpProvider", b"HttpProvider"]) -> None: ...
