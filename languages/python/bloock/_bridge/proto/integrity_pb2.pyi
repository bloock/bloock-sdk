...
class SendRecordsRequest(google.protobuf.message.Message):
    ...
    @property
    def records(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "config_data", b"config_data", "records", b"records"]) -> None: ...
...
class SendRecordsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "_error", b"_error", "error", b"error", "records", b"records"]) -> None: ...
...
class GetAnchorRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "anchor_id", b"anchor_id", "config_data", b"config_data"]) -> None: ...
...
class GetAnchorResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[
        "_anchor", b"_anchor", "_error", b"_error", "anchor", b"anchor", "error", b"error"]) -> builtins.bool: ...

    def ClearField(self, field_name: typing_extensions.Literal[
        "_anchor", b"_anchor", "_error", b"_error", "anchor", b"anchor", "error", b"error"]) -> None: ...

    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_anchor", b"_anchor"]) -> typing_extensions.Literal[
                                                                                               "anchor"] | None: ...
...
class WaitAnchorRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "anchor_id", b"anchor_id", "config_data", b"config_data", "timeout", b"timeout"]) -> None: ...
...
class GetProofResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[
        "_error", b"_error", "error", b"error", "proof", b"proof"]) -> builtins.bool: ...

    def ClearField(self, field_name: typing_extensions.Literal[
        "_error", b"_error", "error", b"error", "proof", b"proof"]) -> None: ...
...
class ValidateRootRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "config_data", b"config_data", "network", b"network", "root", b"root"]) -> None: ...
...
class ValidateRootResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[
        "_error", b"_error", "error", b"error", "timestamp", b"timestamp"]) -> None: ...
...
class VerifyProofRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[
        "config_data", b"config_data", "proof", b"proof"]) -> builtins.bool: ...

    def ClearField(self,
                   field_name: typing_extensions.Literal["config_data", b"config_data", "proof", b"proof"]) -> None: ...
...
class VerifyRecordsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[
        "_network", b"_network", "config_data", b"config_data", "network", b"network"]) -> builtins.bool: ...

    def ClearField(self, field_name: typing_extensions.Literal[
        "_network", b"_network", "config_data", b"config_data", "network", b"network", "records", b"records"]) -> None: ...

    def WhichOneof(self, oneof_group: typing_extensions.Literal["_network", b"_network"]) -> typing_extensions.Literal[
                                                                                                 "network"] | None: ...
