...
func (c *AvailabilityClient) Publish(r record.Record, publisher availability.Publisher) (string, *availability.IpnsKey, error) {
	...
	return res.Id, availability.NewIpnsKeyFromProto(res.IpnsKey), nil
}
