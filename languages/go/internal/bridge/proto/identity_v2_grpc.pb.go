...
func (c *identityServiceV2Client) CreateVerification(ctx context.Context, in *CreateVerificationRequest, opts ...grpc.CallOption) (*CreateVerificationResponse, error) {
	out := new(CreateVerificationResponse)
	err := c.cc.Invoke(ctx, "/bloock.IdentityServiceV2/CreateVerification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityServiceV2Client) WaitVerification(ctx context.Context, in *WaitVerificationRequest, opts ...grpc.CallOption) (*WaitVerificationResponse, error) {
	out := new(WaitVerificationResponse)
	err := c.cc.Invoke(ctx, "/bloock.IdentityServiceV2/WaitVerification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityServiceV2Client) GetVerificationStatus(ctx context.Context, in *GetVerificationStatusRequest, opts ...grpc.CallOption) (*GetVerificationStatusResponse, error) {
	out := new(GetVerificationStatusResponse)
	err := c.cc.Invoke(ctx, "/bloock.IdentityServiceV2/GetVerificationStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIdentityServiceV2Server) CreateVerification(context.Context, *CreateVerificationRequest) (*CreateVerificationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateVerification not implemented")
}
func (UnimplementedIdentityServiceV2Server) WaitVerification(context.Context, *WaitVerificationRequest) (*WaitVerificationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WaitVerification not implemented")
}
func (UnimplementedIdentityServiceV2Server) GetVerificationStatus(context.Context, *GetVerificationStatusRequest) (*GetVerificationStatusResponse, error) {
...
func _IdentityServiceV2_CreateVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateVerificationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IdentityServiceV2Server).CreateVerification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bloock.IdentityServiceV2/CreateVerification",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentityServiceV2Server).CreateVerification(ctx, req.(*CreateVerificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _IdentityServiceV2_WaitVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WaitVerificationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IdentityServiceV2Server).WaitVerification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bloock.IdentityServiceV2/WaitVerification",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentityServiceV2Server).WaitVerification(ctx, req.(*WaitVerificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _IdentityServiceV2_GetVerificationStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVerificationStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IdentityServiceV2Server).GetVerificationStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bloock.IdentityServiceV2/GetVerificationStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentityServiceV2Server).GetVerificationStatus(ctx, req.(*GetVerificationStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IdentityServiceV2_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _IdentityServiceV2_CreateVerification_Handler,
		},
		{
			MethodName: "WaitVerification",
			Handler:    _IdentityServiceV2_WaitVerification_Handler,
		},
		{
			MethodName: "GetVerificationStatus",
			Handler:    _IdentityServiceV2_GetVerificationStatus_Handler,
		},
	},
