...
var file_record_proto_rawDesc = []byte{
	...
	0x72, 0x88, 0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2a, 0x4d,
	...
	0x04, 0x12, 0x0a, 0x0a, 0x06, 0x52, 0x45, 0x43, 0x4f, 0x52, 0x44, 0x10, 0x05, 0x32, 0xd2, 0x01,
	...
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x1c, 0x2e, 0x62, 0x6c, 0x6f, 0x6f, 0x63, 0x6b, 0x2e,
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71,
	...
	0x73, 0x68, 0x42, 0x51, 0x0a, 0x1c, 0x62, 0x6c, 0x6f, 0x6f, 0x63, 0x6b, 0x2e, 0x73, 0x64, 0x6b,
	0x2e, 0x6a, 0x61, 0x76, 0x61, 0x2e, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62,
	0x6c, 0x6f, 0x6f, 0x63, 0x6b, 0x2f, 0x67, 0x6f, 0x2d, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x2f,
...
var file_record_proto_goTypes = []interface{}{
	...
	(*RecordHash)(nil),            // 1: bloock.RecordHash
	(*RecordHeader)(nil),          // 2: bloock.RecordHeader
	(*Record)(nil),                // 3: bloock.Record
	(*Signer)(nil),                // 4: bloock.Signer
	(*SignerArgs)(nil),            // 5: bloock.SignerArgs
	(*Encrypter)(nil),             // 6: bloock.Encrypter
	(*EncrypterArgs)(nil),         // 7: bloock.EncrypterArgs
	(*Signature)(nil),             // 8: bloock.Signature
	(*SignatureHeader)(nil),       // 9: bloock.SignatureHeader
	(*Encryption)(nil),            // 10: bloock.Encryption
	(*EncryptionHeader)(nil),      // 11: bloock.EncryptionHeader
	(*RecordReceipt)(nil),         // 12: bloock.RecordReceipt
	(*RecordBuilderRequest)(nil),  // 13: bloock.RecordBuilderRequest
	(*RecordBuilderResponse)(nil), // 14: bloock.RecordBuilderResponse
	(*SendRecordsRequest)(nil),    // 15: bloock.SendRecordsRequest
	(*SendRecordsResponse)(nil),   // 16: bloock.SendRecordsResponse
	(*Error)(nil),                 // 17: bloock.Error
	(*Proof)(nil),                 // 18: bloock.Proof
	(*ConfigData)(nil),            // 19: bloock.ConfigData
}
var file_record_proto_depIdxs = []int32{
	17, // 0: bloock.RecordHash.error:type_name -> bloock.Error
	2,  // 1: bloock.Record.headers:type_name -> bloock.RecordHeader
	8,  // 2: bloock.Record.signatures:type_name -> bloock.Signature
	10, // 3: bloock.Record.encryption:type_name -> bloock.Encryption
	18, // 4: bloock.Record.proof:type_name -> bloock.Proof
	5,  // 5: bloock.Signer.args:type_name -> bloock.SignerArgs
	7,  // 6: bloock.Encrypter.args:type_name -> bloock.EncrypterArgs
	9,  // 7: bloock.Signature.header:type_name -> bloock.SignatureHeader
	11, // 8: bloock.Encryption.header:type_name -> bloock.EncryptionHeader
	4,  // 9: bloock.RecordBuilderRequest.signer:type_name -> bloock.Signer
	6,  // 10: bloock.RecordBuilderRequest.encrypter:type_name -> bloock.Encrypter
	3,  // 11: bloock.RecordBuilderResponse.record:type_name -> bloock.Record
	17, // 12: bloock.RecordBuilderResponse.error:type_name -> bloock.Error
	19, // 13: bloock.SendRecordsRequest.config_data:type_name -> bloock.ConfigData
	12, // 14: bloock.SendRecordsResponse.records:type_name -> bloock.RecordReceipt
	17, // 15: bloock.SendRecordsResponse.error:type_name -> bloock.Error
	15, // 16: bloock.RecordService.SendRecords:input_type -> bloock.SendRecordsRequest
	13, // 17: bloock.RecordService.BuildRecord:input_type -> bloock.RecordBuilderRequest
	3,  // 18: bloock.RecordService.GetHash:input_type -> bloock.Record
	16, // 19: bloock.RecordService.SendRecords:output_type -> bloock.SendRecordsResponse
	14, // 20: bloock.RecordService.BuildRecord:output_type -> bloock.RecordBuilderResponse
	1,  // 21: bloock.RecordService.GetHash:output_type -> bloock.RecordHash
