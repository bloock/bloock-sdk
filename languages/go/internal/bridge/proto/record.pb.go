...
var file_record_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x6d, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x48, 0x61, 0x73, 0x68, 0x52, 0x65, 0x71, 0x75,
	...
	0x6e, 0x66, 0x69, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x26, 0x0a, 0x06, 0x72, 0x65, 0x63, 0x6f,
	...
	0x22, 0x59, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x48, 0x61, 0x73, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x64, 0x32, 0x9a, 0x06, 0x0a, 0x0d, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x5e, 0x0a, 0x15, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65, 0x63, 0x6f,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x62, 0x6c, 0x6f, 0x6f, 0x63, 0x6b, 0x2e, 0x52, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x3a, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x48, 0x61, 0x73, 0x68, 0x12, 0x16,
	0x2e, 0x62, 0x6c, 0x6f, 0x6f, 0x63, 0x6b, 0x2e, 0x47, 0x65, 0x74, 0x48, 0x61, 0x73, 0x68, 0x52,
	...
	0x3d, 0x0a, 0x08, 0x53, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x12, 0x17, 0x2e, 0x62, 0x6c,
	0x6f, 0x6f, 0x63, 0x6b, 0x2e, 0x53, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x62, 0x6c, 0x6f, 0x6f, 0x63, 0x6b, 0x2e, 0x53, 0x65,
	0x74, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x57,
...
var file_record_proto_goTypes = []interface{}{
	...
	(*GetHashRequest)(nil),                 // 8: bloock.GetHashRequest
	(*GetHashResponse)(nil),                // 9: bloock.GetHashResponse
	(*SetProofRequest)(nil),                // 10: bloock.SetProofRequest
	(*SetProofResponse)(nil),               // 11: bloock.SetProofResponse
	(*ConfigData)(nil),                     // 12: bloock.ConfigData
	(*Signer)(nil),                         // 13: bloock.Signer
	(*Encrypter)(nil),                      // 14: bloock.Encrypter
	(*Decrypter)(nil),                      // 15: bloock.Decrypter
	(*Record)(nil),                         // 16: bloock.Record
	(*Error)(nil),                          // 17: bloock.Error
	(*Loader)(nil),                         // 18: bloock.Loader
	(*Proof)(nil),                          // 19: bloock.Proof
}
var file_record_proto_depIdxs = []int32{
	12, // 0: bloock.RecordBuilderFromStringRequest.config_data:type_name -> bloock.ConfigData
	13, // 1: bloock.RecordBuilderFromStringRequest.signer:type_name -> bloock.Signer
	14, // 2: bloock.RecordBuilderFromStringRequest.encrypter:type_name -> bloock.Encrypter
	15, // 3: bloock.RecordBuilderFromStringRequest.decrypter:type_name -> bloock.Decrypter
	12, // 4: bloock.RecordBuilderFromHexRequest.config_data:type_name -> bloock.ConfigData
	13, // 5: bloock.RecordBuilderFromHexRequest.signer:type_name -> bloock.Signer
	14, // 6: bloock.RecordBuilderFromHexRequest.encrypter:type_name -> bloock.Encrypter
	15, // 7: bloock.RecordBuilderFromHexRequest.decrypter:type_name -> bloock.Decrypter
	12, // 8: bloock.RecordBuilderFromJSONRequest.config_data:type_name -> bloock.ConfigData
	13, // 9: bloock.RecordBuilderFromJSONRequest.signer:type_name -> bloock.Signer
	14, // 10: bloock.RecordBuilderFromJSONRequest.encrypter:type_name -> bloock.Encrypter
	15, // 11: bloock.RecordBuilderFromJSONRequest.decrypter:type_name -> bloock.Decrypter
	12, // 12: bloock.RecordBuilderFromBytesRequest.config_data:type_name -> bloock.ConfigData
	13, // 13: bloock.RecordBuilderFromBytesRequest.signer:type_name -> bloock.Signer
	14, // 14: bloock.RecordBuilderFromBytesRequest.encrypter:type_name -> bloock.Encrypter
	15, // 15: bloock.RecordBuilderFromBytesRequest.decrypter:type_name -> bloock.Decrypter
	12, // 16: bloock.RecordBuilderFromFileRequest.config_data:type_name -> bloock.ConfigData
	13, // 17: bloock.RecordBuilderFromFileRequest.signer:type_name -> bloock.Signer
	14, // 18: bloock.RecordBuilderFromFileRequest.encrypter:type_name -> bloock.Encrypter
	15, // 19: bloock.RecordBuilderFromFileRequest.decrypter:type_name -> bloock.Decrypter
	12, // 20: bloock.RecordBuilderFromRecordRequest.config_data:type_name -> bloock.ConfigData
	16, // 21: bloock.RecordBuilderFromRecordRequest.payload:type_name -> bloock.Record
	13, // 22: bloock.RecordBuilderFromRecordRequest.signer:type_name -> bloock.Signer
	14, // 23: bloock.RecordBuilderFromRecordRequest.encrypter:type_name -> bloock.Encrypter
	15, // 24: bloock.RecordBuilderFromRecordRequest.decrypter:type_name -> bloock.Decrypter
	16, // 25: bloock.RecordBuilderResponse.record:type_name -> bloock.Record
	17, // 26: bloock.RecordBuilderResponse.error:type_name -> bloock.Error
	12, // 27: bloock.RecordBuilderFromLoaderRequest.config_data:type_name -> bloock.ConfigData
	18, // 28: bloock.RecordBuilderFromLoaderRequest.loader:type_name -> bloock.Loader
	13, // 29: bloock.RecordBuilderFromLoaderRequest.signer:type_name -> bloock.Signer
	14, // 30: bloock.RecordBuilderFromLoaderRequest.encrypter:type_name -> bloock.Encrypter
	15, // 31: bloock.RecordBuilderFromLoaderRequest.decrypter:type_name -> bloock.Decrypter
	12, // 32: bloock.GetHashRequest.config_data:type_name -> bloock.ConfigData
	16, // 33: bloock.GetHashRequest.record:type_name -> bloock.Record
	17, // 34: bloock.GetHashResponse.error:type_name -> bloock.Error
	12, // 35: bloock.SetProofRequest.config_data:type_name -> bloock.ConfigData
	16, // 36: bloock.SetProofRequest.record:type_name -> bloock.Record
	19, // 37: bloock.SetProofRequest.proof:type_name -> bloock.Proof
	17, // 38: bloock.SetProofResponse.error:type_name -> bloock.Error
	16, // 39: bloock.SetProofResponse.record:type_name -> bloock.Record
	0,  // 40: bloock.RecordService.BuildRecordFromString:input_type -> bloock.RecordBuilderFromStringRequest
	1,  // 41: bloock.RecordService.BuildRecordFromHex:input_type -> bloock.RecordBuilderFromHexRequest
	2,  // 42: bloock.RecordService.BuildRecordFromJson:input_type -> bloock.RecordBuilderFromJSONRequest
	4,  // 43: bloock.RecordService.BuildRecordFromFile:input_type -> bloock.RecordBuilderFromFileRequest
	3,  // 44: bloock.RecordService.BuildRecordFromBytes:input_type -> bloock.RecordBuilderFromBytesRequest
	5,  // 45: bloock.RecordService.BuildRecordFromRecord:input_type -> bloock.RecordBuilderFromRecordRequest
	7,  // 46: bloock.RecordService.BuildRecordFromLoader:input_type -> bloock.RecordBuilderFromLoaderRequest
	8,  // 47: bloock.RecordService.GetHash:input_type -> bloock.GetHashRequest
	10, // 48: bloock.RecordService.SetProof:input_type -> bloock.SetProofRequest
	6,  // 49: bloock.RecordService.BuildRecordFromString:output_type -> bloock.RecordBuilderResponse
	6,  // 50: bloock.RecordService.BuildRecordFromHex:output_type -> bloock.RecordBuilderResponse
	6,  // 51: bloock.RecordService.BuildRecordFromJson:output_type -> bloock.RecordBuilderResponse
	6,  // 52: bloock.RecordService.BuildRecordFromFile:output_type -> bloock.RecordBuilderResponse
	6,  // 53: bloock.RecordService.BuildRecordFromBytes:output_type -> bloock.RecordBuilderResponse
	6,  // 54: bloock.RecordService.BuildRecordFromRecord:output_type -> bloock.RecordBuilderResponse
	6,  // 55: bloock.RecordService.BuildRecordFromLoader:output_type -> bloock.RecordBuilderResponse
	9,  // 56: bloock.RecordService.GetHash:output_type -> bloock.GetHashResponse
	11, // 57: bloock.RecordService.SetProof:output_type -> bloock.SetProofResponse
