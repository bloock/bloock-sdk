...
var file_record_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x72, 0x2a, 0x4d, 0x0a, 0x0b, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x54, 0x79, 0x70,
	...
	0x10, 0x05, 0x2a, 0x17, 0x0a, 0x09, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x41, 0x6c, 0x67, 0x12,
	0x0a, 0x0a, 0x06, 0x45, 0x53, 0x32, 0x35, 0x36, 0x4b, 0x10, 0x00, 0x2a, 0x1c, 0x0a, 0x0d, 0x45,
	0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x6c, 0x67, 0x12, 0x0b, 0x0a, 0x07,
	0x41, 0x32, 0x35, 0x36, 0x47, 0x43, 0x4d, 0x10, 0x00, 0x32, 0x81, 0x06, 0x0a, 0x0d, 0x52, 0x65,
	...
	0x73, 0x68, 0x12, 0x49, 0x0a, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x4b, 0x65,
	...
	0x65, 0x4b, 0x65, 0x79, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x58, 0x0a,
	0x1c, 0x62, 0x6c, 0x6f, 0x6f, 0x63, 0x6b, 0x2e, 0x73, 0x64, 0x6b, 0x2e, 0x6a, 0x61, 0x76, 0x61,
...
var file_record_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_record_proto_goTypes = []interface{}{
	...
	(*RecordBuilderResponse)(nil),          // 23: bloock.RecordBuilderResponse
	(*SendRecordsRequest)(nil),             // 24: bloock.SendRecordsRequest
	(*SendRecordsResponse)(nil),            // 25: bloock.SendRecordsResponse
	(*Error)(nil),                          // 26: bloock.Error
	(*ConfigData)(nil),                     // 27: bloock.ConfigData
}
var file_record_proto_depIdxs = []int32{
	26, // 0: bloock.GenerateKeysResponse.error:type_name -> bloock.Error
	26, // 1: bloock.RecordHash.error:type_name -> bloock.Error
	1,  // 2: bloock.Signer.alg:type_name -> bloock.SignerAlg
	9,  // 3: bloock.Signer.args:type_name -> bloock.SignerArgs
	2,  // 4: bloock.Encrypter.alg:type_name -> bloock.EncryptionAlg
	11, // 5: bloock.Encrypter.args:type_name -> bloock.EncrypterArgs
	2,  // 6: bloock.Decrypter.alg:type_name -> bloock.EncryptionAlg
	13, // 7: bloock.Decrypter.args:type_name -> bloock.DecrypterArgs
	15, // 8: bloock.Signature.header:type_name -> bloock.SignatureHeader
	8,  // 9: bloock.RecordBuilderFromStringRequest.signer:type_name -> bloock.Signer
	10, // 10: bloock.RecordBuilderFromStringRequest.encrypter:type_name -> bloock.Encrypter
	12, // 11: bloock.RecordBuilderFromStringRequest.decrypter:type_name -> bloock.Decrypter
	8,  // 12: bloock.RecordBuilderFromHexRequest.signer:type_name -> bloock.Signer
	10, // 13: bloock.RecordBuilderFromHexRequest.encrypter:type_name -> bloock.Encrypter
	12, // 14: bloock.RecordBuilderFromHexRequest.decrypter:type_name -> bloock.Decrypter
	8,  // 15: bloock.RecordBuilderFromJSONRequest.signer:type_name -> bloock.Signer
	10, // 16: bloock.RecordBuilderFromJSONRequest.encrypter:type_name -> bloock.Encrypter
	12, // 17: bloock.RecordBuilderFromJSONRequest.decrypter:type_name -> bloock.Decrypter
	...
	12, // 20: bloock.RecordBuilderFromBytesRequest.decrypter:type_name -> bloock.Decrypter
	8,  // 21: bloock.RecordBuilderFromFileRequest.signer:type_name -> bloock.Signer
	10, // 22: bloock.RecordBuilderFromFileRequest.encrypter:type_name -> bloock.Encrypter
	12, // 23: bloock.RecordBuilderFromFileRequest.decrypter:type_name -> bloock.Decrypter
	7,  // 24: bloock.RecordBuilderFromRecordRequest.payload:type_name -> bloock.Record
	8,  // 25: bloock.RecordBuilderFromRecordRequest.signer:type_name -> bloock.Signer
	10, // 26: bloock.RecordBuilderFromRecordRequest.encrypter:type_name -> bloock.Encrypter
	12, // 27: bloock.RecordBuilderFromRecordRequest.decrypter:type_name -> bloock.Decrypter
	7,  // 28: bloock.RecordBuilderResponse.record:type_name -> bloock.Record
	26, // 29: bloock.RecordBuilderResponse.error:type_name -> bloock.Error
	27, // 30: bloock.SendRecordsRequest.config_data:type_name -> bloock.ConfigData
	16, // 31: bloock.SendRecordsResponse.records:type_name -> bloock.RecordReceipt
	26, // 32: bloock.SendRecordsResponse.error:type_name -> bloock.Error
	24, // 33: bloock.RecordService.SendRecords:input_type -> bloock.SendRecordsRequest
	17, // 34: bloock.RecordService.BuildRecordFromString:input_type -> bloock.RecordBuilderFromStringRequest
	18, // 35: bloock.RecordService.BuildRecordFromHex:input_type -> bloock.RecordBuilderFromHexRequest
	19, // 36: bloock.RecordService.BuildRecordFromJson:input_type -> bloock.RecordBuilderFromJSONRequest
	21, // 37: bloock.RecordService.BuildRecordFromFile:input_type -> bloock.RecordBuilderFromFileRequest
	20, // 38: bloock.RecordService.BuildRecordFromBytes:input_type -> bloock.RecordBuilderFromBytesRequest
	22, // 39: bloock.RecordService.BuildRecordFromRecord:input_type -> bloock.RecordBuilderFromRecordRequest
	...
	25, // 42: bloock.RecordService.SendRecords:output_type -> bloock.SendRecordsResponse
	23, // 43: bloock.RecordService.BuildRecordFromString:output_type -> bloock.RecordBuilderResponse
	23, // 44: bloock.RecordService.BuildRecordFromHex:output_type -> bloock.RecordBuilderResponse
	23, // 45: bloock.RecordService.BuildRecordFromJson:output_type -> bloock.RecordBuilderResponse
	23, // 46: bloock.RecordService.BuildRecordFromFile:output_type -> bloock.RecordBuilderResponse
	23, // 47: bloock.RecordService.BuildRecordFromBytes:output_type -> bloock.RecordBuilderResponse
	23, // 48: bloock.RecordService.BuildRecordFromRecord:output_type -> bloock.RecordBuilderResponse
	5,  // 49: bloock.RecordService.GetHash:output_type -> bloock.RecordHash
	4,  // 50: bloock.RecordService.GenerateKeys:output_type -> bloock.GenerateKeysResponse
