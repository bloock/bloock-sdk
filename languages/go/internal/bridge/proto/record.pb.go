...
type Record struct {
	...
	Proof      *Proof        `protobuf:"bytes,6,opt,name=proof,proto3,oneof" json:"proof,omitempty"`
}
...
var file_record_proto_rawDesc = []byte{
	...
	0x66, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x62, 0x6c, 0x6f, 0x6f, 0x63, 0x6b,
