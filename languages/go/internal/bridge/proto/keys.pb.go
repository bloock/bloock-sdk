...
var file_keys_proto_rawDesc = []byte{
	...
	,
...
var file_keys_proto_goTypes = []interface{}{
	...
	(KeyType)(0),                       // 5: bloock.KeyType
	(*LocalKey)(nil),                   // 6: bloock.LocalKey
	(*Error)(nil),                      // 7: bloock.Error
	(*ManagedKeyParams)(nil),           // 8: bloock.ManagedKeyParams
	(*ManagedKey)(nil),                 // 9: bloock.ManagedKey
}
var file_keys_proto_depIdxs = []int32{
	4,  // 0: bloock.GenerateLocalKeyRequest.config_data:type_name -> bloock.ConfigData
	5,  // 1: bloock.GenerateLocalKeyRequest.key_type:type_name -> bloock.KeyType
	6,  // 2: bloock.GenerateLocalKeyResponse.local_key:type_name -> bloock.LocalKey
	7,  // 3: bloock.GenerateLocalKeyResponse.error:type_name -> bloock.Error
	4,  // 4: bloock.GenerateManagedKeyRequest.config_data:type_name -> bloock.ConfigData
	8,  // 5: bloock.GenerateManagedKeyRequest.params:type_name -> bloock.ManagedKeyParams
	9,  // 6: bloock.GenerateManagedKeyResponse.managed_key:type_name -> bloock.ManagedKey
	7,  // 7: bloock.GenerateManagedKeyResponse.error:type_name -> bloock.Error
	0,  // 8: bloock.KeyService.GenerateLocalKey:input_type -> bloock.GenerateLocalKeyRequest
	2,  // 9: bloock.KeyService.GenerateManagedKey:input_type -> bloock.GenerateManagedKeyRequest
	1,  // 10: bloock.KeyService.GenerateLocalKey:output_type -> bloock.GenerateLocalKeyResponse
	3,  // 11: bloock.KeyService.GenerateManagedKey:output_type -> bloock.GenerateManagedKeyResponse
