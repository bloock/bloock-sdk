...
type KeyServiceClient interface {
	...
	SetupOTPAccessControl(ctx context.Context, in *SetupOTPAccessControlRequest, opts ...grpc.CallOption) (*SetupOTPAccessControlResponse, error)
	...
	RecoverOTPAccessControl(ctx context.Context, in *RecoverOTPAccessControlRequest, opts ...grpc.CallOption) (*RecoverOTPAccessControlResponse, error)
}
...
func (c *keyServiceClient) SetupOTPAccessControl(ctx context.Context, in *SetupOTPAccessControlRequest, opts ...grpc.CallOption) (*SetupOTPAccessControlResponse, error) {
	out := new(SetupOTPAccessControlResponse)
	err := c.cc.Invoke(ctx, "/bloock.KeyService/SetupOTPAccessControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keyServiceClient) RecoverOTPAccessControl(ctx context.Context, in *RecoverOTPAccessControlRequest, opts ...grpc.CallOption) (*RecoverOTPAccessControlResponse, error) {
	out := new(RecoverOTPAccessControlResponse)
	err := c.cc.Invoke(ctx, "/bloock.KeyService/RecoverOTPAccessControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KeyServiceServer interface {
	...
	SetupOTPAccessControl(context.Context, *SetupOTPAccessControlRequest) (*SetupOTPAccessControlResponse, error)
	SetupSecretAccessControl(context.Context, *SetupSecretAccessControlRequest) (*SetupSecretAccessControlResponse, error)
	RecoverOTPAccessControl(context.Context, *RecoverOTPAccessControlRequest) (*RecoverOTPAccessControlResponse, error)
...
func (UnimplementedKeyServiceServer) SetupOTPAccessControl(context.Context, *SetupOTPAccessControlRequest) (*SetupOTPAccessControlResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetupOTPAccessControl not implemented")
}
...
func (UnimplementedKeyServiceServer) RecoverOTPAccessControl(context.Context, *RecoverOTPAccessControlRequest) (*RecoverOTPAccessControlResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RecoverOTPAccessControl not implemented")
}
...
func _KeyService_SetupOTPAccessControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetupOTPAccessControlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeyServiceServer).SetupOTPAccessControl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bloock.KeyService/SetupOTPAccessControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyServiceServer).SetupOTPAccessControl(ctx, req.(*SetupOTPAccessControlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KeyService_RecoverOTPAccessControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RecoverOTPAccessControlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeyServiceServer).RecoverOTPAccessControl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bloock.KeyService/RecoverOTPAccessControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyServiceServer).RecoverOTPAccessControl(ctx, req.(*RecoverOTPAccessControlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KeyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetupOTPAccessControl",
			Handler:    _KeyService_SetupOTPAccessControl_Handler,
		},
		{
		...
		{
			MethodName: "RecoverOTPAccessControl",
			Handler:    _KeyService_RecoverOTPAccessControl_Handler,
		},
	},
