...
var file_identity_v2_proto_rawDesc = []byte{
	...
	0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x90, 0x03, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61,
	...
	,
...
var file_identity_v2_proto_goTypes = []interface{}{
	...
	(*CredentialReceiptV2)(nil),              // 51: bloock.CredentialReceiptV2
	(*IssuerStateReceipt)(nil),               // 52: bloock.IssuerStateReceipt
	(*CredentialRevocationV2)(nil),           // 53: bloock.CredentialRevocationV2
...
var file_identity_v2_proto_depIdxs = []int32{
	...
	49, // 37: bloock.GetIssuerByKeyRequest.issuer_key:type_name -> bloock.IdentityKey
	28, // 38: bloock.GetIssuerByKeyRequest.config_data:type_name -> bloock.ConfigData
	50, // 39: bloock.GetIssuerByKeyRequest.issuer_params:type_name -> bloock.DidParams
	28, // 40: bloock.PublishIssuerStateRequest.config_data:type_name -> bloock.ConfigData
	33, // 41: bloock.PublishIssuerStateRequest.signer:type_name -> bloock.Signer
	51, // 42: bloock.CreateCredentialResponseV2.credential_receipt:type_name -> bloock.CredentialReceiptV2
	30, // 43: bloock.CreateCredentialResponseV2.error:type_name -> bloock.Error
	30, // 44: bloock.CreateIdentityV2Response.error:type_name -> bloock.Error
	30, // 45: bloock.CreateIssuerResponse.error:type_name -> bloock.Error
	29, // 46: bloock.BuildSchemaResponseV2.schema:type_name -> bloock.SchemaV2
	30, // 47: bloock.BuildSchemaResponseV2.error:type_name -> bloock.Error
	52, // 48: bloock.PublishIssuerStateResponse.state_receipt:type_name -> bloock.IssuerStateReceipt
	30, // 49: bloock.PublishIssuerStateResponse.error:type_name -> bloock.Error
	28, // 50: bloock.RevokeCredentialRequestV2.config_data:type_name -> bloock.ConfigData
	32, // 51: bloock.RevokeCredentialRequestV2.credential:type_name -> bloock.CredentialV2
	33, // 52: bloock.RevokeCredentialRequestV2.signer:type_name -> bloock.Signer
	53, // 53: bloock.RevokeCredentialResponseV2.result:type_name -> bloock.CredentialRevocationV2
	30, // 54: bloock.RevokeCredentialResponseV2.error:type_name -> bloock.Error
	28, // 55: bloock.CreateVerificationRequest.config_data:type_name -> bloock.ConfigData
	54, // 56: bloock.CreateVerificationResponse.result:type_name -> bloock.VerificationReceipt
	30, // 57: bloock.CreateVerificationResponse.error:type_name -> bloock.Error
	28, // 58: bloock.WaitVerificationRequest.config_data:type_name -> bloock.ConfigData
	30, // 59: bloock.WaitVerificationResponse.error:type_name -> bloock.Error
	28, // 60: bloock.GetVerificationStatusRequest.config_data:type_name -> bloock.ConfigData
	30, // 61: bloock.GetVerificationStatusResponse.error:type_name -> bloock.Error
	11, // 62: bloock.IdentityServiceV2.CreateIdentity:input_type -> bloock.CreateIdentityV2Request
	12, // 63: bloock.IdentityServiceV2.CreateIssuer:input_type -> bloock.CreateIssuerRequest
	13, // 64: bloock.IdentityServiceV2.GetIssuerByKey:input_type -> bloock.GetIssuerByKeyRequest
	10, // 65: bloock.IdentityServiceV2.BuildSchema:input_type -> bloock.BuildSchemaRequestV2
	0,  // 66: bloock.IdentityServiceV2.GetSchema:input_type -> bloock.GetSchemaRequestV2
	9,  // 67: bloock.IdentityServiceV2.CreateCredential:input_type -> bloock.CreateCredentialRequestV2
	3,  // 68: bloock.IdentityServiceV2.GetCredentialProof:input_type -> bloock.GetCredentialProofRequest
	20, // 69: bloock.IdentityServiceV2.RevokeCredential:input_type -> bloock.RevokeCredentialRequestV2
	5,  // 70: bloock.IdentityServiceV2.CredentialToJson:input_type -> bloock.CredentialToJsonRequestV2
	7,  // 71: bloock.IdentityServiceV2.CredentialFromJson:input_type -> bloock.CredentialFromJsonRequestV2
	14, // 72: bloock.IdentityServiceV2.PublishIssuerState:input_type -> bloock.PublishIssuerStateRequest
	22, // 73: bloock.IdentityServiceV2.CreateVerification:input_type -> bloock.CreateVerificationRequest
	24, // 74: bloock.IdentityServiceV2.WaitVerification:input_type -> bloock.WaitVerificationRequest
	26, // 75: bloock.IdentityServiceV2.GetVerificationStatus:input_type -> bloock.GetVerificationStatusRequest
	16, // 76: bloock.IdentityServiceV2.CreateIdentity:output_type -> bloock.CreateIdentityV2Response
	17, // 77: bloock.IdentityServiceV2.CreateIssuer:output_type -> bloock.CreateIssuerResponse
	2,  // 78: bloock.IdentityServiceV2.GetIssuerByKey:output_type -> bloock.GetIssuerByKeyResponse
	18, // 79: bloock.IdentityServiceV2.BuildSchema:output_type -> bloock.BuildSchemaResponseV2
	1,  // 80: bloock.IdentityServiceV2.GetSchema:output_type -> bloock.GetSchemaResponseV2
	15, // 81: bloock.IdentityServiceV2.CreateCredential:output_type -> bloock.CreateCredentialResponseV2
	4,  // 82: bloock.IdentityServiceV2.GetCredentialProof:output_type -> bloock.GetCredentialProofResponse
	21, // 83: bloock.IdentityServiceV2.RevokeCredential:output_type -> bloock.RevokeCredentialResponseV2
	6,  // 84: bloock.IdentityServiceV2.CredentialToJson:output_type -> bloock.CredentialToJsonResponseV2
	8,  // 85: bloock.IdentityServiceV2.CredentialFromJson:output_type -> bloock.CredentialFromJsonResponseV2
	19, // 86: bloock.IdentityServiceV2.PublishIssuerState:output_type -> bloock.PublishIssuerStateResponse
	23, // 87: bloock.IdentityServiceV2.CreateVerification:output_type -> bloock.CreateVerificationResponse
	25, // 88: bloock.IdentityServiceV2.WaitVerification:output_type -> bloock.WaitVerificationResponse
	27, // 89: bloock.IdentityServiceV2.GetVerificationStatus:output_type -> bloock.GetVerificationStatusResponse
