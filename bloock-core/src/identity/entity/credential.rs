...
impl Serialize for CredentialProof {
        ...
        S: serde::Serializer,
    {
        ...
        let signature_map = signature
            .as_object_mut()
            .ok_or(Error::custom("error serializing signature"))?;
        ...
        let proof_map = proof
            .as_object_mut()
            .ok_or(Error::custom("error serializing bloock proof"))?;
        proof_map.insert(
            "type".to_string(),
    ...
    fn try_from(value: RedeemCredentialResponse) -> Result<Self, Self::Error> {
        Ok(Credential {
            ...
            body: CredentialBody {
                ...
                proof: CredentialProof(value.body.proof.0, value.body.proof.1),
            },
        })
    }
}
