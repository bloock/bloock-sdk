...
impl VC {
    ...
    fn new_internal(
        ...
        let credential_id = format!("{}/v1/credentials/{}", api_managed_host, uuid);
...
mod tests {
    ...
    fn create_credential() -> VC {
        let context_json_ld =
            "https://api.bloock.com/hosting/v1/ipfs/QmUrnNeUvaeb5uQGQEEmxUvqCRzxrkknqP5CKS8q6X3tKH"
                .to_string();
